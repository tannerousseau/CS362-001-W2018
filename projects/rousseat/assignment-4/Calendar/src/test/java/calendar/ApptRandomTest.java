	...
	public void radnomtest()  throws Throwable  {
		...
		try{
			for (int iteration = 0; elapsed < TestTimeout; iteration++) {
				...
				if ( (startHour < 0 || startHour > 23) || (startMinute < 0 || startMinute > 59) || (startDay < 1 || startDay > numDaysInMonth) || (startMonth<1 || startMonth>12)) {
				...
				for (int i = 0; i < NUM_TESTS; i++) {
					...
					if (methodName.equals("setTitle")){
						...
						if(ValuesGenerator.getRandomIntBetween(random, 0, 10) < 5){
							recurDays = null;
							...
							appt.setRecurrence(recurDays, recur, recurIncrement, recurNumber);
							//assertEquals(appt.getRecurDays.size(), recurDays.length());
						}
